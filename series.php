...
<body class="area">
  ...
  <?php
    ...
    $category= 'series';
    $sql = 'SELECT * FROM posters WHERE category="series"';
...
echo("</div>");
      echo("<div class='product-footer'>");
        ...
        echo('<form method="POST" action="addtocart.php"><button type="submit" class="addtocartbtn" name="add" value="'.$row["productID"].'">Add to cart</a>
        </div></div>');}
        mysqli_close($con);
    ?>
</div>
